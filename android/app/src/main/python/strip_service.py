...
# Data Persistence
_DATA_DIR = os.path.abspath(get_config("LIGHT_DATA_DIR", os.environ.get("HOME", os.getcwd())))
os.makedirs(_DATA_DIR, exist_ok=True)
DATA_FILE = os.path.join(_DATA_DIR, "latest_strip_data.json")
STRIP_COMMAND_FILE = os.path.join(_DATA_DIR, "latest_strip_command.json")
