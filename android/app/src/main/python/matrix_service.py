...
_BASE_DIR = os.path.abspath(get_config("LIGHT_DATA_DIR", os.environ.get("HOME", _PACKAGE_DIR)))
os.makedirs(_BASE_DIR, exist_ok=True)
DATA_FILE = os.path.join(_BASE_DIR, "latest_led_data.json")
ANIMATION_DATA_FILE = os.path.join(_BASE_DIR, "latest_matrix_animation.json")
